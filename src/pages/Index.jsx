              ...
              {showScore ? (
                ...
                <div>
                  ...
                  <div className="flex justify-center space-x-4">
                    <Button onClick={() => handleAnswerSubmit(true)} className="bg-green-600 hover:bg-green-700">True</Button>
                    <Button onClick={() => handleAnswerSubmit(false)} className="bg-green-600 hover:bg-green-700">False</Button>
                  </div>
                </div>
              )}
            </CardContent>
